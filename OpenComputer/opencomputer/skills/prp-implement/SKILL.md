---
name: prp-implement
description: Execute an implementation plan with rigorous validation loops. Use when you have a finished PRP plan and need to ship the code with continuous type/lint/test checks.
---
