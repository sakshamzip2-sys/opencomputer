---
name: prp-prd
description: Interactive PRD generator — problem-first, hypothesis-driven product spec with back-and-forth questioning. Use when starting a new product or feature spec.
---
