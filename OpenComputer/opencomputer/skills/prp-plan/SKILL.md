---
name: prp-plan
description: Create a comprehensive feature implementation plan with codebase analysis and pattern extraction. Use when turning a PRD phase or free-form description into a self-contained plan.
---
