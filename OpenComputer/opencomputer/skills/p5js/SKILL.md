---
name: p5js
description: "Production pipeline for interactive and generative visual art using p5.js. Creates browser-based sketches, generative art, data viz, interactive experiences, 3D scenes, audio-reactive visuals, and motion graphics — exported as HTML, PNG, GIF, MP4, or SVG. Covers 2D/3D, particle systems, flow fields, GLSL shaders, WebGL, audio analysis, input handling, headless high-res export. Use for any p5.js sketch, creative-coding task, canvas animation, or shader effect."
version: 1.0.0
metadata:
  hermes:
