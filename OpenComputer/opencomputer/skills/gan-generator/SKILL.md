---
name: gan-generator
description: GAN Harness — Generator role. Implements features according to the spec, reads evaluator feedback, and iterates until quality threshold is met. Use as the builder side of the iterative build-test-fix loop.
---
