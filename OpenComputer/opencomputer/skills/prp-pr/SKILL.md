---
name: prp-pr
description: Create a GitHub PR from current branch with unpushed commits — discovers templates, analyzes changes, pushes, opens the PR. Use when implementation is complete and you want a PR.
---
