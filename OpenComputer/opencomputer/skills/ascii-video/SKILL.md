---
name: ascii-video
description: "Production pipeline for ASCII art video — any format. Converts video/audio/images/generative input into colored ASCII character video (MP4, GIF, image sequence). Covers video-to-ASCII conversion, audio-reactive music visualizers, generative ASCII animations, video+audio hybrids, text/lyrics overlays, real-time terminal rendering. Use for ASCII video, terminal-style video, character art animation, retro text visualization, matrix-style effects, or any animated ASCII output."
---
