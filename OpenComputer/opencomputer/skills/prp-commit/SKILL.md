---
name: prp-commit
description: Quick commit with natural language file targeting — describe what to commit in plain English. Use when staging and committing partial changes by intent rather than file path.
---
