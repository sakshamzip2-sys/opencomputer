...
def _real_user_home() -> Path:
    ...
    every `get_default_root()` caller that expects ~/.opencomputer/
    to resolve to the real ~/.opencomputer/ (active_profile lookup,
    profile path resolution, etc.) — instead they get
...
def get_default_root() -> Path:
    ...
    return _real_user_home() / ".opencomputer"
