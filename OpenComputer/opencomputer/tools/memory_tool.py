...
class MemoryTool(BaseTool):
    ...
    def schema(self) -> ToolSchema:
        return ToolSchema(
            name="Memory",
            description=(
                "Read or mutate declarative memory. Use this to remember facts "
                "across sessions — things the agent learned about itself "
                "(target='memory') or preferences the user stated "
                "(target='user').\n\n"
                "Actions:\n"
