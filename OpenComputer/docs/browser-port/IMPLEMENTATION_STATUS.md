...
| **W6** | **control-extension port + daemon WS + Track 1 auto-load** | [wave6-control-extension/BLUEPRINT](wave6-control-extension/BLUEPRINT.md) | **6** | W4 merged | s1 | feat/wave6-control-extension | review | (pending) | OpenCLI extension verbatim port (Apache 2.0); Python daemon WS at `127.0.0.1:18792/ext`; new `control-extension` BrowserDriver; Track 1 `--load-extension` baked into managed Chrome args. 34 new tests + 587 existing pass. Ships 8 of 14 actions; rest in v0.6.x |
