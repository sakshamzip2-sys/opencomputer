...
>
> Last updated: 2026-05-03 by s3 (Wave 1 claim — W1a/W1b/W1c bundled on one branch).
...
| W1a | `session/` | [BRIEF-02](BRIEF-02-cdp-and-session.md) | 1 | `chrome/` | s3 | feat/browser-port-wave1 | claimed | — | CDP attach, nav guard, page management |
| W1b | `snapshot/` | [BRIEF-04](BRIEF-04-ai-and-snapshot.md) | 1 | `_utils/` | s3 | feat/browser-port-wave1 | claimed | — | role snapshot + Chrome MCP subprocess |
| W1c | `server_context/` | [BRIEF-05](BRIEF-05-server-and-auth.md) | 1 | `chrome/`, `profiles/` | s3 | feat/browser-port-wave1 | claimed | — | per-profile state holder; can develop in parallel against mocks |
