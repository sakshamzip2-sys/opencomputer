...
| W1a | `session/` | [BRIEF-02](BRIEF-02-cdp-and-session.md) | 1 | `chrome/` | s3 | feat/browser-port-wave1 | review | (PR pending) | 73 tests; CDP dedup + retry, force-disconnect, role-ref LRU, nav guard |
| W1b | `snapshot/` | [BRIEF-04](BRIEF-04-ai-and-snapshot.md) | 1 | `_utils/` | s3 | feat/browser-port-wave1 | review | (PR pending) | 35 tests; Path 2 (aria) + Path 3 (Chrome MCP), 7×6 screenshot grid |
| W1c | `server_context/` | [BRIEF-05](BRIEF-05-server-and-auth.md) | 1 | `chrome/`, `profiles/` | s3 | feat/browser-port-wave1 | review | (PR pending) | 37 tests; ProfileDriver injection, last_target_id fallback chain |
