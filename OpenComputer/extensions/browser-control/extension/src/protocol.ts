...
// Modifications:
//   - DAEMON_PORT: 19825 → 18792 (browser-control's existing daemon port)
//   - Renames are confined to the constants block; type definitions are verbatim.

/**
 * OpenComputer browser control protocol — shared types between daemon, extension, and CLI.
 *
 * 5 actions (full set: 14): exec, navigate, tabs, cookies, screenshot.
...
/** Default daemon port (browser-control's existing daemon) */
export const DAEMON_PORT = 18792;
