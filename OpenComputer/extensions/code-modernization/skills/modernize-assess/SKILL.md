...
description: Step 1 of modernization — discovery and complexity assessment of a legacy system or portfolio. Inventory, lines-of-code, complexity hotspots, technical debt, effort estimation. Use when the user asks to assess a legacy codebase, size up an old system, estimate modernization effort, run a portfolio assessment, or get a debt heatmap. Args are the system dir name (resolves to legacy/NAME) or --portfolio PARENT for multi-system rollup. Output goes to analysis/NAME.
version: 0.1.0
---
