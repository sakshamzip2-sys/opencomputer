---
name: modernize-map
description: Step 2 of the modernization pipeline — build a dependency-and-topology map of a legacy system. Call graphs, data lineage, batch flows rendered as navigable Mermaid/Graphviz diagrams. Use when the user says map this legacy system, show me how the modules connect, draw the data lineage, or what depends on what here. Args after the slash invocation are the system dir name (resolves to legacy/NAME). Output goes to analysis/NAME — diagrams + indexed dependency tables.
version: 0.1.0
---
