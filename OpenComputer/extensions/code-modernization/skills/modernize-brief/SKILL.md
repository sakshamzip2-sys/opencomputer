...
description: Step 4 of modernization — synthesize prior assessment, map, and rules artifacts into a single phased Modernization Brief. The steering-committee-approvable plan that transformation agents will execute against. Use when the user says generate the modernization brief, give me the migration plan, or what is the phased approach. Args are the system dir name and an optional target stack. Reads from analysis/NAME, writes the brief there.
version: 0.1.0
---
