...
description: Step 6 of the modernization pipeline — surgical single-module transformation. Rewrite one legacy module idiomatically into the target stack, with behavior-equivalence tests proving the new code matches the old. Use when the user says transform module X to Y, port this module, or rewrite this legacy file as Python. One vertical slice of the strangler fig. Args are the system dir name, module name, and target stack. Output goes to modernized/SYSTEM/MODULE.
version: 0.1.0
---
