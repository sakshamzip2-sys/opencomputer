"""Smoke tests for the P1.e provider cohort (Vercel AI Gateway, Xiaomi MiMo).

All values verified against /Users/saksham/.hermes/hermes-agent/hermes_cli/auth.py.
Same isolation pattern as test_p1d_provider_cohort.
"""
...
COHORT = [
    ("vercel-ai-gateway-provider", "VercelAIGatewayProvider", "ai-gateway",
     "AI_GATEWAY_API_KEY", "ai-gateway.vercel.sh"),
    ("xiaomi-provider",            "XiaomiProvider",          "xiaomi",
     "XIAOMI_API_KEY",     "xiaomimimo.com"),
]
