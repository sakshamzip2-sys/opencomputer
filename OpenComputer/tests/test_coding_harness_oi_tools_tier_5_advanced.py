...
import pytest
from extensions.coding_harness.oi_bridge.tools.tier_5_advanced import (
    ALL_TOOLS,
...
class TestAllTier5ToolsList:
    ...
    def test_all_tools_have_capability_claims(self):
        """Every Tier 5 tool must declare capability_claims (PR-3: replaces # CONSENT_HOOK marker).
